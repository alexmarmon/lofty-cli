...
class Builder {
  ...
  buildFromTemplate = (cwd, templatePath, newFilePath, data) => new Promise((resolve, reject) => {
  ...
  buildFilesFromTemplate = (templatePath, destPath, data, nameMaps) => new Promise((resolve) => {
